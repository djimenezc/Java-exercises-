...
public class AngryProfessor {
    ...
    private static final String FILE_FOLDER = "files/angryProfessor/";
...
//        Scanner s = new Scanner(System.in);
        ...
        for (int i = 0; i < numberTestcases; i++) {
            ...
            String paramsLine = s.nextLine();
            Integer n = Integer.parseInt(paramsLine.split(" ")[0]);
            Integer k = Integer.parseInt(paramsLine.split(" ")[1]);
            String studentArrival = s.nextLine();
            int counterArrivalOnTime = 0;

            for (String arrival : studentArrival.split(" ")) {
                if (Integer.parseInt(arrival) < 1) {
                    counterArrivalOnTime++;
                }
            }

            String result = counterArrivalOnTime >= k ? "NO" : "YES";
